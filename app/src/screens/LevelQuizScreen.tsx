...
export default function LevelQuizScreen() {
  ...
  function onTimeout() {
    ...
    // Level 1: timeout never costs a heart — it's the tutorial level
      ...
      {showTutorial && (
        <View style={styles.tutorialOverlay}>
          <View style={styles.tutorialCard}>
            ...
            <Text style={styles.tutorialLine}>⚡ Bonne réponse = tu voles</Text>
            <Text style={styles.tutorialLine}>❌ Mauvaise réponse = −1 ❤️</Text>
...
const styles = StyleSheet.create({
  ...
  tutorialLine: { fontFamily: fonts.bodyBold, fontSize: 14, color: colors.ink, marginTop: 10 },
  storyIntro: { fontFamily: fonts.bodyBold, fontSize: 13, fontStyle: 'italic', color: colors.inkSoft, marginTop: 8, textAlign: 'center', lineHeight: 18 },
  tutorialBtn: {
